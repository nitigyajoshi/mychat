...
class OwnMessage extends StatelessWidget {
  ...
  const OwnMessage({ Key key,this.messages }) : super(key: key);
...
child: Text(messages,style: TextStyle(fontSize: 15,color: Colors.grey[600]),),)
,Positioned(bottom: 4,right: 10,child:Row(
children: [
Text('10:20',style: TextStyle(fontSize: 15,color: Colors.grey[600])),
SizedBox(width: 5,),
Icon(Icons.done_all)
